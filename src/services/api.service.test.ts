...
vi.mock('./helperBridge', () => ({ pushHelperToken: vi.fn().mockResolvedValue(true) }));

import { ApiService, refreshAccessToken, startTokenAutoRefresh, stopTokenAutoRefresh } from './api.service';
