...
vi.mock('../../../src/components/Profile/PersonalTab', () => ({ default: () => <div data-testid="personal-tab" /> }));
vi.mock('../../../src/components/Profile/CompanyTab', () => ({
  default: ({ companyId }: { companyId: string }) => (
    <div data-testid="company-tab">{companyId}</div>
  ),
}));
vi.mock('../../../src/components/Settings/BrandingPage', () => ({ default: () => <div data-testid="branding" /> }));
